...
- `data::NamedTuple`: expects the following fields:
    ...
    - `ϵ::Float64`: convergence threshold
...
"""
function build(modeltype::Type{MyNaiveKMeansClusteringAlgorithm}, 
    data::NamedTuple)::MyNaiveKMeansClusteringAlgorithm
